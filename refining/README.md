...
- b.1. prepare motovis object data (see [Daemon](../daemon/README.md) for more details)
```shell
cd DetZero/daemon &&
python prepare_object_motovis_data.py --track_data_path <PATH_TO_TRACKING_RESULT> --split <DATA_SPLIT> --root_dir <PATH_TO_SENSOR_DATA>
```
