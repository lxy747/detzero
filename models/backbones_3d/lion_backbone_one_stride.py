...
from ...utils.retnet_attn import Block as RetNetBlock
# from ...utils.rwkv_cls import Block as RWKVBlock
...
class LION3DBackboneOneStride(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size, **kwargs):
        ...
        # down_scale_list = [[1, 1, 2],
        #                    [1, 1, 2],
        #                    [1, 1, 2],
        #                    [1, 1, 2]
        #                    ]
        down_scale_list = model_cfg.get('down_scale_list', 
                        [
                            [1, 1, 2],
                            [1, 1, 2],
                            [1, 1, 2],
        ...
        self.dow1 = PatchMerging3D(self.layer_dim[0], self.layer_dim[0], down_scale=down_scale_list[0], # [1, 1, 2],
        ...
        self.dow2 = PatchMerging3D(self.layer_dim[1], self.layer_dim[1], down_scale=down_scale_list[1], # [1, 1, 2],
                                     norm_layer=norm_fn, diffusion=diffusion, diff_scale=diff_scale)
        ...
        self.dow3 = PatchMerging3D(self.layer_dim[2], self.layer_dim[3], down_scale=down_scale_list[2], # [1, 1, 2],
                                     norm_layer=norm_fn, diffusion=diffusion, diff_scale=diff_scale)
        ...
        self.dow4 = PatchMerging3D(self.layer_dim[3], self.layer_dim[3], down_scale=down_scale_list[3], # [1, 1, 2],
                                     norm_layer=norm_fn, diffusion=diffusion, diff_scale=diff_scale)
