...
class CenterHead(nn.Module):
    ...
    def generate_predicted_boxes(self, batch_size, pred_dicts):
        ...
        for k in range(batch_size):
            ...
            if ret_dict[k]['pred_scores'].shape[0]>post_process_cfg.MAX_OBJ_PER_SAMPLE:
                inds = torch.topk(ret_dict[k]['pred_scores'], k=post_process_cfg.MAX_OBJ_PER_SAMPLE)[1]
                ret_dict[k]['pred_boxes'] = ret_dict[k]['pred_boxes'][inds]
                ret_dict[k]['pred_scores'] = ret_dict[k]['pred_scores'][inds]
                ret_dict[k]['pred_labels'] = ret_dict[k]['pred_labels'][inds]
        return ret_dict
